			...
			<div class="row clearfix">
				...
				<div class="col-md-6 column">
					<div class="list-group">
						...
						""")))})),format.raw/*63.8*/("""
						<a class="list-group-item active"><span class="badge">"""),_display_(Seq[Any](/*64.62*/cnt)),format.raw/*64.65*/("""</span>More</a>
					</div>
				</div>
			</div>
		</div>
