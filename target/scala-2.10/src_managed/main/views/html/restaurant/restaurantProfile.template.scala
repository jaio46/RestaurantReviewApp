			...
			<table class="table">
				...
				"""),_display_(Seq[Any](/*61.6*/for(food<-foodList) yield /*61.25*/{_display_(Seq[Any](format.raw/*61.26*/("""
					<tr>
						...
						<td>
						"""),_display_(Seq[Any](/*67.8*/common/*67.14*/.rating("/foodItem/"+food.id,food.rating))),format.raw/*67.55*/("""
						</td>
					</tr>
				""")))})),format.raw/*70.6*/("""
				</tbody>
...
"""),_display_(Seq[Any](/*81.2*/common/*81.8*/.footer())),format.raw/*81.17*/("""
    ...
    def ref: this.type = this
                ...
                /*
                    -- GENERATED --
                    DATE: Fri Oct 24 23:47:59 BDT 2014
                    SOURCE: /Users/sheikhahmed/Projects/RestaurantApp/app/views/restaurant/restaurantProfile.scala.html
                    HASH: 63c0888d33576c83ea2b4676a9a25742687536e0
                    MATRIX: 886->1|1131->133|1158->153|1228->189|1242->195|1308->240|1360->257|1374->263|1414->281|1567->399|1586->409|1623->424|1661->426|1676->432|1752->486|2037->736|2056->746|2096->764|2186->819|2205->829|2243->845|2332->899|2351->909|2389->925|2690->1191|2725->1210|2764->1211|2829->1241|2842->1245|2873->1254|2939->1285|2954->1291|3017->1332|3077->1361|3304->1553|3317->1558|3376->1595|3422->1606|3436->1612|3467->1621
