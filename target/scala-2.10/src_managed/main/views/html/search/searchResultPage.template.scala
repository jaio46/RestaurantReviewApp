			...
			"""),_display_(Seq[Any](/*31.5*/if(foods.isEmpty==false)/*31.29*/{_display_(Seq[Any](format.raw/*31.30*/("""
				<div class="list-group">
					...
					"""),_display_(Seq[Any](/*34.7*/for(food<-foods) yield /*34.23*/{_display_(Seq[Any](format.raw/*34.24*/("""
						<div class="list-group-item">
							<a href='/restaurant/"""),_display_(Seq[Any](/*36.30*/food/*36.34*/.restaurant.id)),format.raw/*36.48*/("""'>"""),_display_(Seq[Any](/*36.51*/food/*36.55*/.itemName)),format.raw/*36.64*/(""" from """),_display_(Seq[Any](/*36.71*/food/*36.75*/.restaurant.restaurantName)),format.raw/*36.101*/("""</a>
						</div>
					""")))})),format.raw/*38.7*/("""
